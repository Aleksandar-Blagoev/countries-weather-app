class RegisterController {
    ...
    render = () => {
        ...
        let registerName = getElement('inputRegisterUser');
        let registerPassInput = getElement('inputPasswordRegister');
    ...
    verifyPassword = () => {
        let registerName = getElement('inputRegisterUser');
        let registerPassInput = getElement('inputPasswordRegister');
        let registerPassConfirm = getElement('inputPasswordConfirm');
